...
const firebaseConfig = {
  ...
  appId: "1:560499676685:web:bca946ecdd5ea7edd0e744",
  measurementId: "G-HPRZSBHFEQ"
};
...
export const fetchProtectedDataFromFirestore = async () => {
  try {
    const docRef = doc(db, "protected_data", "demo_doc"); // Adjust collection/document as needed
